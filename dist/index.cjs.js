...
var InputSpinner = /** @class */ (function (_super) {
    ...
    InputSpinner.prototype.renderLeftButton = function () {
        var _this = this;
        return (React__default['default'].createElement(reactBootstrap.Button, { id: "input-spinner-left-button", variant: this.props.variant, size: this.props.size, disabled: this.isDisabledButtonLeft(), onClick: function () { return _this.decrease(); } }, this.renderLeftButtonElement()));
    };
    InputSpinner.prototype.renderRightButton = function () {
        var _this = this;
        return (React__default['default'].createElement(reactBootstrap.Button, { id: "input-spinner-right-button", variant: this.props.variant, size: this.props.size, disabled: this.isDisabledButtonRight(), onClick: function () { return _this.increase(); } }, this.renderRightButtonElement()));
    };
    InputSpinner.prototype.render = function () {
        var _this = this;
        return (React__default['default'].createElement(reactBootstrap.InputGroup, { size: this.props.size },
            React__default['default'].createElement(reactBootstrap.InputGroup.Prepend, null, this.renderLeftButton()),
            this.props.prepend,
            React__default['default'].createElement(reactBootstrap.Form.Control, { value: this.getValue(undefined), readOnly: !this.isEditable(), onChange: function (event) { return _this.onChange(event.target.value, undefined); }, onBlur: this.onBlur.bind(this) }),
            this.props.children,
            this.props.append,
            React__default['default'].createElement(reactBootstrap.InputGroup.Append, null, this.renderRightButton())));
    };
