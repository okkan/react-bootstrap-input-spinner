...
var InputSpinner = /** @class */ (function (_super) {
    ...
    InputSpinner.prototype.renderLeftButton = function () {
        var _this = this;
        return (React.createElement(Button, { id: "input-spinner-left-button", variant: this.props.variant, size: this.props.size, disabled: this.isDisabledButtonLeft(), onClick: function () { return _this.decrease(); } }, this.renderLeftButtonElement()));
    };
    InputSpinner.prototype.renderRightButton = function () {
        var _this = this;
        return (React.createElement(Button, { id: "input-spinner-right-button", variant: this.props.variant, size: this.props.size, disabled: this.isDisabledButtonRight(), onClick: function () { return _this.increase(); } }, this.renderRightButtonElement()));
    };
